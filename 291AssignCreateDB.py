...
conn = sqlite3.connect(r"A3Large.db")
cur = conn.cursor()
...
customers = customers.sample(n=33000)  # 10000    20000   33000
...
sellers = sellers.sample(n=1000)  # 500     750   1000
...
orders = orders.sample(n=33000)  # 10000    20000     33000
...
items = items.sample(n=10000)  # 2000     4000     10000
